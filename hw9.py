...
#print(questify(['e', 'efwef', 'efrgvesv','fvdfvdf']))
#print(questifyAlt(['e', 'efwef', 'efrgvesv','fvdfvdf']))
...
def catenateLoop(str_list):
    ...
    for s in str_list:
        result=result +s
    return result
#print (catenate(['e', 'efwef', 'efrgvesv','fvdfvdf'])) 
#print(catenateLoop(['e', 'efwef', 'efrgvesv','fvdfvdf'])) 
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 3
...
def letterScoreLoop(letter, scorelist):
    ...
    for l in scorelist:
        ...
        count+=1
    return result
#print(letterScoreLoop('x',scrabbleScores))
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 4
...
def wordScoreLoop(S, scorelist):
    ...
    result = 0
    for c in S:
        result= result +letterScore(c, scorelist)
    return result

#print(wordScore('hotpotato', scrabbleScores))
#print(wordScoreLoop('hotpotato', scrabbleScores))
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 5
...
def wordsWithScoreLambda(dct, scores):
    ...
    return map(lambda w: [w, wordScore(w, scores)], dct)
...
def wordsWithScoreLoop(dct, scores):
    ...
    result= []
    for wrd in dct:
        result= result + [[wrd, wordScore(wrd,scores)]]
    return result
#print(wordsWithScoreLoop(aDictionary, scrabbleScores))